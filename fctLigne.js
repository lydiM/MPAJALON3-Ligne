...
document.getElementById('lat').value = dx;
var radius = Math.sqrt(dx*dx + dy*dy); // calcul de la longeur de la  ligne
document.getElementById('dist').value = radius/1852;   //mettre la valeur dans le champs
...
//newCoordinates.push( [point[0] , last[1] ] ,[point[0] , point[1] ], [last[0], last[1]]);

newCoordinates.push([point[0] , point[1] ], [last[0], last[1]]);

//newCoordinates.push( [point[0] , last[1] ] , [point[0], last[1]], [point[0], point[1]]);
